...
VERSION=
commit=false
url=https://github.com/actinium-project/litecore-actinium
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the bitcoin, gitian-builder, gitian.sigs.ltc, and actinium-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/actinium-project/litecore-actinium
