...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"actiniumaddress\"\n"
            "\nReturn information about the given Actinium address.\n"
            "\nArguments:\n"
            "1. \"actiniumaddress\"     (string, required) The Actinium address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"actiniumaddress\", (string) The Actinium address validated\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"actiniumaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"actiniumaddress\"  (string, required) The Actinium address to use for the signature.\n"
